 ...
 * Used to: 1) render sidebar, 2) redirect users without Dashboard access to first allowed page.
 */
export const NAV_ITEMS = [
  ...
  {
    id: 'ga4-advanced',
    label: 'GA4 · Advanced (page / VDP)',
    section: 'Analytics & CRM',
    permission: 'sidebar.analytics',
    /** Shown only for Wheeler agency — raw + classified page analytics */
    wheelerOnlyGa4: true,
    logo: <svg viewBox="0 0 24 24" width="16" height="16"><path d="M3.14 16.5l4.94-8.57a2 2 0 013.46 0L16.47 16.5a2 2 0 01-1.73 3H4.87a2 2 0 01-1.73-3z" fill="#E37400"/><circle cx="18.5" cy="17" r="3" fill="#F9AB00"/><circle cx="18.5" cy="7" r="3" fill="#E37400"/></svg>,
  },
  {
  ...
  {
    id: 'ghl', label: 'GHL Leads', section: 'Analytics & CRM',
    permission: 'sidebar.ghl',
    logo: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="none" aria-hidden>
        <rect width="24" height="24" rx="4" fill="#28A745" />
        <path
          d="M18.2 16.75v2.2a1.45 1.45 0 01-1.58 1.45 14.3 14.3 0 01-6.24-2.22 14.1 14.1 0 01-4.33-4.33 14.3 14.3 0 01-2.22-6.26A1.45 1.45 0 015.75 5.8h2.2a1.45 1.45 0 011.45 1.24 9.3 9.3 0 00.5 2.03 1.45 1.45 0 01-.33 1.53L8.5 11.9a11.6 11.6 0 004.33 4.33l.92-.92a1.45 1.45 0 011.53-.33 9.3 9.3 0 002.03.5 1.45 1.45 0 011.49 1.37z"
          fill="#fff"
        />
      </svg>
    ),
