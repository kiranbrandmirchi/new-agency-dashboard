...
export function DateRangePicker({
  ...
  const triggerRowStyle = blockLayout
  ...
  return (
    <div
      ...
      style={{
        ...
        gap: 4,
        width: blockLayout ? '100%' : undefined,
      }}
    >
      <div
      ...
      >
        ...
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" style={{ color: 'var(--text-muted)', marginLeft: '2px', flexShrink: 0 }}>
      ...
      {compareOn && (
        <div
          ...
          style={blockLayout ? { ...triggerRowStyle, fontSize: '12px' } : { fontSize: '12px' }}
          onClick={toggle}
        >
          <span className="dp-label" style={{ color: 'var(--primary)' }}>vs</span>
          {blockLayout && <span style={{ flex: 1, minWidth: 8 }} aria-hidden />}
